...
import Aula, { meta } from "@/content/modulo-03/aula-04.mdx";

export default function Modulo03Aula04Page() {
  return (
    <article className="pf-card">
      ...
      <footer className="mt-8x flex justify-end border-t border-zinc-800 pt-4x light:border-zinc-200">
        <Link href="/curso/modulo-03/projeto" className="pf-btn-primary">
