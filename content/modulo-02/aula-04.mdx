...
Reproduza o exemplo de operadores lógicos e o `%` da aula: calcule se
`idade = 20` com `tem_carteira = True` permite dirigir, e o resto da
divisão de 10 por 3.

<PyPlayground
  titulo="operadores"
  codigoInicial={`# escreva o código da aula acima e rode para conferir
`}
