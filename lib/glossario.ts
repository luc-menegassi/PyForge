...
export const GLOSSARIO_MODULO_03: GlossarioItem[] = [
  ...
  { termo: "Correspondência de padrões (match/case)", definicao: "Recurso do Python (desde a versão 3.10) que compara um valor contra vários padrões possíveis — alternativa mais legível a cadeias longas de elif quando os valores são conhecidos.", aula: "Módulo 3 — Aula 4" },
  { termo: "Guarda", definicao: "Condição extra adicionada a um case do match (case valor if condição:), necessária para comparações que a correspondência simples de padrão não resolve sozinha, como intervalos numéricos.", aula: "Módulo 3 — Aula 4" },
];
