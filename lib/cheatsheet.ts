...
export const CHEATSHEET_MODULO_03: CheatItem[] = [
  ...
  { comando: "continue", descricao: "Pula para a próxima repetição do laço, sem interrompê-lo.", categoria: "Sintaxe", aula: "Módulo 3 — Aula 4" },
  { comando: "match valor:", descricao: "Inicia uma comparação de padrões contra o valor informado.", categoria: "Sintaxe", aula: "Módulo 3 — Aula 4" },
  { comando: "case padrao:", descricao: "Um dos padrões possíveis dentro de um match.", categoria: "Sintaxe", aula: "Módulo 3 — Aula 4" },
  { comando: "case _:", descricao: "Padrão coringa do match — funciona como o else de um if.", categoria: "Sintaxe", aula: "Módulo 3 — Aula 4" },
  { comando: "case n if condicao:", descricao: "Guarda: adiciona uma condição extra ao case, necessária para comparações de intervalo.", categoria: "Sintaxe", aula: "Módulo 3 — Aula 4" },
];
